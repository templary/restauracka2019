...
import cz.app.restauracka.demo.logika.obj.Objednavka;
...
public class NactiDataObjednavek {
    ...
    public void loadData() {
        ...
        try {
            ...
            Type listOfPersonsType = new TypeToken<Set<Objednavka>>() {
            }.getType();
            //zamestnanci = gson.fromJson(jsonRaw, listOfPersonsType);

            objednavky.setSetObjednavek(gson.fromJson(jsonRaw, listOfPersonsType));
